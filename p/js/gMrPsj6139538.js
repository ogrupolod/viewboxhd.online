    ...
    (function() {
      try {
        ...
        return error;
          ...
          try {
              const clickeventList = [{"compKey":"715c511","misc":{"type":"button"}},{"compKey":"43a249e","misc":{"type":"text"}},{"compKey":"6f99817","misc":{"type":"button"}},{"compKey":"110a9f4","misc":{"type":"text"}},{"compKey":"c4e3cf2","misc":{"type":"text"}}];
          ...
          try {
              const animationList = [{"key":"715c511","type":"button"},{"key":"6f99817","type":"button"}];
          ...
          (function() {
            try {
              var vturbvideoId = "689372e489c09669a33b760d";
              var compKey = "b2d7f80";
              const twr = false;
